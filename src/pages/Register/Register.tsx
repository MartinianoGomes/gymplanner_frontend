...
export default function Register() {
    ...
    return (
        <div className="grid min-h-screen w-full md:grid-cols-2">
            <div
                className="flex-1 h-auto bg-[url('../../assets/register/image-woman-2.png')] bg-cover bg-center bg-no-repeat bg-primary max-md:hidden"
            ></div>
            ...
            <div className="flex flex-col justify-center m-auto px-10 min-w-[70%] bg-white md:justify-center">
                ...
                <h2 className="text-2xl font-bold mb-2.5 text-dark">Cadastrar</h2>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col">
                    <label htmlFor="name" className="block text-dark font-bold mb-2 text-sm">Nome</label>
                    ...
                    <label htmlFor="email" className="block text-dark font-bold mt-5 mb-2 text-sm">E-mail</label>
                    ...
                    <label htmlFor="confirmPassword" className="block text-dark font-bold mt-5 mb-2 text-sm">Confirmar Senha</label>
                    ...
                    <p className="text-[13px] text-dark-lighter text-center mt-2">
                        Já possui conta? {' '}
                        <a href="/login" className="no-underline text-primary hover:text-primary-dark hover:underline transition-colors">
